                        ...
                        <div class="card h-100 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-grid gap-2 my-4">
                                    <?php
                                    echo "<a href='javascript:void(0)' onclick='confirmDelete($id_item)' class='btn btn-warning bold-btn'>Delete Item</a>";
                                    echo "<a href='up_date_item.php?id=$id_item' class='btn btn-warning bold-btn'>Update Item</a>";
                                    ?>
                                </div>
                            </div>
                        </div>
