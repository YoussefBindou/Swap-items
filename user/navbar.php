  ...
  <body>
    ...
    <div id="menuHolder">
          ...
          <div class="flex2 text-end d-none d-md-block">
            <nav >
              <ul>
                ...
                <li>
                  <img src="<?php echo $fetch_info['img']; ?>" class="profile">
                 <ul>
                    <li class="sub-item">
      ...
      <div id="menuDrawer">
        ...
        <div>
          <a href="../user/profile_update.php" class="nav-menu-item" > <img src="<?php echo $fetch_info['img']?>" class="profile" > <?php echo $fetch_info['name'] ?></a>
          ...
          <?php
                    ...
                    ?>
          <a href="../admin/home.php" class="nav-menu-item"><i class="fas fa-user-shield me-3"></i>BACKEND</a>
          <?php
                    }
                    ?>
